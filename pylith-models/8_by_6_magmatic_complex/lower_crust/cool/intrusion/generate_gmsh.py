...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        p8 = gmsh.model.geo.add_point(4000, -36000, 0.0)
        p9 = gmsh.model.geo.add_point(0,-36000, 0.0)
        p10 = gmsh.model.geo.add_point(-4000, -36000, 0.0)
        p11 = gmsh.model.geo.add_point(4000, -30000, 0.0)
        p12 = gmsh.model.geo.add_point(-4000, -30000, 0.0)
