...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        p8 = gmsh.model.geo.add_point(4000, -50000, 0.0)
        p9 = gmsh.model.geo.add_point(0,-50000, 0.0)
        p10 = gmsh.model.geo.add_point(-4000, -50000, 0.0)
        p11 = gmsh.model.geo.add_point(4000, -56000, 0.0)
        p12 = gmsh.model.geo.add_point(-4000, -56000, 0.0)
        ...
        c0 = gmsh.model.geo.add_curve_loop([self.c_yneg, self.c_xpos1, 
                                            self.c_mid1, self.c_int_connect,
                                            -self.c_int_top_2, -self.c_int_right,
                                            -self.c_int_bottom,-self.c_int_left,
                                            -self.c_int_top_1, -self.c_int_connect,
                                            self.c_mid2, self.c_xneg2])
        self.s_mantle = gmsh.model.geo.add_plane_surface([c0])

        #Crust
        c1 = gmsh.model.geo.add_curve_loop([-self.c_mid2, -self.c_mid1,
                                             self.c_xpos2, self.c_ypos,
                                             self.c_xneg1])
        ...
        c2 = gmsh.model.geo.add_curve_loop([self.c_int_bottom, self.c_int_right, 
