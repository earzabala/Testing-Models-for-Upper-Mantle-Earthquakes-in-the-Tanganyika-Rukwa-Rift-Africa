...
class App(GenerateMesh):
    ...
    def create_geometry(self):
        ...
        p7 = gmsh.model.geo.add_point(2000, y1+20.0e+3, 0.0)
        p8 = gmsh.model.geo.add_point(-2000, y1+20.0e+3, 0.0)
        p9 = gmsh.model.geo.add_point(2000, -48000, 0.0)
        p10 = gmsh.model.geo.add_point(-2000,-48000, 0.0)
